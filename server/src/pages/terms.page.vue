<template>
  ...
  <div>
    <div>
      <p>
        ...
        Service&quot;) carefully before using the https://www.arcadecord.com
        website (the &quot;Service&quot;) operated by DSTORM Technologies LLC
        (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;).
      </p>
      <p>
  ...
  <div>
    ...
    <div>
      <p>
        ...
        are not owned or controlled by DSTORM Technologies LLC.
      </p>
      <p>
        DSTORM Technologies LLC has no control over, and assumes no
      ...
      <p>
        You acknowledge and agree that DSTORM Technologies LLC shall not be
  ...
  <div>
    ...
    <div>
      <p>
        You agree to defend, indemnify and hold harmless DSTORM Technologies LLC
        ...
        arising out of a) your use and access of the Service, or b) a breach of
        these Terms.
      </p>
    </div>
  </div>
  <div>
    ...
    <div>
      ...
      <p>
        DSTORM Technologies LLC its subsidiaries, affiliates, and its licensors
  ...
  <div>
    ...
    <div>
      <p>
        ...
        of North Carolina, United States, without regard to its conflict of law
        provisions.
      </p>
      <p>
  ...
  <div>
    ...
    <div>
      <p>
        ...
        <a href="contactarcadecord@gmail.com">contactarcadecord@gmail.com</a>
      </p>
    </div>
  </div>
</template>
