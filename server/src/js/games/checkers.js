    ...
    const App = {
        data() {
            return {
                ...
                collumns: Array(8).fill(0).map((x, _) => (_ % 2) ?
                    Array(8).fill(0).map((x, _) => _ % 2) :
                    Array(8).fill(0).map((x, _) => (_ + 1) % 2)),
        ...
        methods: {
            ...
            ask() {
                ...
                Client.runAction(this.game, 'ask', { question: this.question }, (response) => {
