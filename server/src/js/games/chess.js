  ...
  if (side == 'white') {
    for (i = 0; i < 8; i++) {
      for (j = 0; j < 8; j++) {
        ...
        window[files[j] + ranks[i]] = new component(
          50,
          50,
          color,
          50 * j,
        ...
        window[files[j] + ranks[i] + 'i'] = new component(
          50,
          50,
          piecesImages[0],
          50 * j,
    ...
    for (i = 0; i < 8; i++) {
      for (j = 0; j < 8; j++) {
        ...
        window[otherFiles[j] + (i + 1)] = new component(
          50,
          50,
          color,
          50 * j,
        ...
        window[otherFiles[j] + (i + 1) + 'i'] = new component(
          50,
          50,
          piecesImages[0],
          50 * j,
        ...
        if (board[i][j] == 'P') {
          try {
            if (
              ...
              moves[moves.length] =
                files[j] + ranks[i] + files[j] + (ranks[i] - 1 + 3)
            }
          } catch (err) {
            console.log(err)
          }
          if (board[i - 1][j] == '') {
            if (i == 1) {
              moves[moves.length] =
                files[j] + ranks[i] + files[j] + (ranks[i] - 1 + 2) + 'P'
            } else {
              moves[moves.length] =
                files[j] + ranks[i] + files[j] + (ranks[i] - 1 + 2)
            }
          }
          if (piecesBlack.includes(board[i - 1][j - 1])) {
            moves[moves.length] =
              files[j] + ranks[i] + files[j - 1] + ranks[i - 1]
          }
          if (piecesBlack.includes(board[i - 1][j + 1])) {
            moves[moves.length] =
              files[j] + ranks[i] + files[j + 1] + ranks[i - 1]
          ...
          if (
            ...
            files[j + 1] + ranks[i - 2] + files[j + 1] + ranks[i]
          ) {
            moves[moves.length] =
              files[j] + ranks[i] + files[j + 1] + ranks[i - 1]
          }
          ...
          for (l = 1; l < 9; l++) {
            if (stopYet) {
              ...
              if (piecesBlack.includes(board[i + l][j])) {
                stopYet = true
                moves[moves.length] =
                  files[j] + ranks[i] + files[j] + (ranks[i] - l)
          ...
          for (l = 1; l < 9; l++) {
            if (stopYet) {
              ...
              if (piecesBlack.includes(board[i - l][j])) {
                stopYet = true
                moves[moves.length] =
                  files[j] + ranks[i] + files[j] + (ranks[i] - 1 + l + 1)
              } else if (piecesWhite.includes(board[i - l][j])) {
                stopYet = true
              } else {
                moves[moves.length] =
          ...
          for (l = 1; l < 9; l++) {
            if (stopYet) {
              ...
              if (piecesBlack.includes(board[i][j - l])) {
                stopYet = true
                moves[moves.length] =
                  files[j] + ranks[i] + files[j - l] + ranks[i]
          ...
          for (l = 1; l < 9; l++) {
            if (stopYet) {
              ...
              if (piecesBlack.includes(board[i - l][j + l])) {
                stopYet = true
                moves[moves.length] =
                  files[j] + ranks[i] + files[j + l] + ranks[i - l]
          ...
          if (i - 2 > -1 && j - 1 > -1) {
            if (!piecesWhite.includes(board[i - 2][j - 1])) {
              moves[moves.length] =
                files[j] + ranks[i] + files[j - 1] + ranks[i - 2]
            }
          }
          if (i - 1 > -1 && j - 2 > -1) {
            if (!piecesWhite.includes(board[i - 1][j - 2])) {
              moves[moves.length] =
                files[j] + ranks[i] + files[j - 2] + ranks[i - 1]
            }
          }
          //UR
          if (i - 2 > -1 && j + 1 < 8) {
          ...
          for (l = 0; l < previousMoves.length; l++) {
            ...
            if (
              previousMoves[l].startsWith('h1') ||
              previousMoves[l].endsWith('h1')
            ) {
              rRookMoved = true
            }
            if (
              previousMoves[l].startsWith('a1') ||
              previousMoves[l].endsWith('a1')
            ) {
              lRookMoved = true
            }
          ...
          if (i - 1 > -1) {
            if (!piecesWhite.includes(board[i - 1][j])) {
              moves[moves.length] =
                files[j] + ranks[i] + files[j] + ranks[i - 1]
            }
          }
          //Down
          if (i + 1 < 8) {
          ...
          if (j - 1 > -1) {
            if (!piecesWhite.includes(board[i][j - 1])) {
              moves[moves.length] =
                files[j] + ranks[i] + files[j - 1] + ranks[i]
              //Long Castle
              if (
                !kingMoved &&
                !lRookMoved &&
                ...
                moves[moves.length] =
                  files[j] + ranks[i] + files[j - 2] + ranks[i]
              }
            }
          }
          //Right
        ...
        if (board[i][j] == 'p') {
          try {
            if (
              ...
              moves[moves.length] =
                files[j] + ranks[i] + files[j] + (ranks[i] - 2)
            }
          } catch (err) {
            console.log(err)
          }
          if (board[i + 1][j] == '') {
            ...
            if (i == 6) {
              moves[moves.length] =
                files[j] + ranks[i] + files[j] + (ranks[i] - 1) + 'P'
            } else {
              moves[moves.length] =
                files[j] + ranks[i] + files[j] + (ranks[i] - 1)
            }
          ...
          for (l = 0; l < previousMoves.length; l++) {
            ...
            if (
              previousMoves[l].startsWith('h8') ||
              previousMoves[l].endsWith('h8')
            ) {
              rRookMoved = true
            }
            if (
              previousMoves[l].startsWith('a8') ||
              previousMoves[l].endsWith('a8')
            ) {
              lRookMoved = true
            }
    ...
    this.update = function () {
      if (this.showing) {
        ...
        gameCanvasContext.fillRect(
          this.ogx - Player.x + 300,
          this.ogy - Player.y + 200,
          this.width,
          this.height
        )
      }
      ...
      handleClick(event) {
        ...
        if (!promotionMenuBlack && !promotionMenuWhite) {
            ...
            for (j = 0; j < 8; j++) {
              if (window[files[j] + ranks[i]].pointerCrash()) {
                if (selectedSquareMoves.includes(files[j] + ranks[i])) {
                  if (
                    (board[ranks.indexOf(selectedSquare[1])][
                    ...
                    App.methods.movePiece(
                      selectedSquare + files[j] + ranks[i] + 'P'
                    )
                  ...
                  for (l = 0; l < legalMoves.length; l++) {
                    if (legalMoves[l].startsWith(files[j] + ranks[i])) {
                      myLegalMoves[myLegalMoves.length] =
                        legalMoves[l][2] + legalMoves[l][3]
                    }
                  }
          ...
          if (promoWQ.pointerCrash()) {
            App.methods.movePiece(
              selectedSquare + selectedPromotionSquare + 'Q'
            )
          } else if (promoWR.pointerCrash()) {
            App.methods.movePiece(
              selectedSquare + selectedPromotionSquare + 'R'
            )
          } else if (promoWB.pointerCrash()) {
            App.methods.movePiece(
              selectedSquare + selectedPromotionSquare + 'B'
            )
          } else if (promoWN.pointerCrash()) {
            App.methods.movePiece(
              selectedSquare + selectedPromotionSquare + 'N'
            )
          }
      ...
      movePiece(move, test, bot) {
        if (App.data().game.isItMyTurn() || bot || test) {
          ...
          if (board[i][j] == 'P' || board[i][j] == 'p') {
            //En passant!!!!!
            if (
              move == files[j] + ranks[i] + files[j + 1] + ranks[i - 1] &&
              previousMoves[previousMoves.length - 1] ==
                files[j + 1] + ranks[i - 2] + files[j + 1] + ranks[i]
            ) {
              board[i][j + 1] = ''
          ...
          board[ranks.indexOf(move[3])][files.indexOf(move[2])] =
